...
class ShipAcrossRiverHarder(gym.Env):
    ...
    def _set_max_water_speed(self):
        ...
        :return:
        '''
        self.max_water_speed = 4 + np.random.standard_normal()
    ...
    def render(self, mode='human'):
        ...
        if self.viewer is None:
            ...
            self.viewer.add_geom(rendering.make_polyline(
                [self._convert_xy2location(self.max_x, self.optimal_y - self.optimal_range, scale=scale, margin=margin),
                 self._convert_xy2location(self.max_x, self.optimal_y + self.optimal_range, scale=scale, margin=margin),
            ...
            self.sub_optimal_goal_1.set_color(*[0xfd / 255, 0xdc / 255, 0x5c / 255])
            ...
            # self.sub_optimal_goal.set_color(*[0.85, 0.35, 0.35])
            self.sub_optimal_goal_2.set_color(*[0xfd / 255, 0xdc / 255, 0x5c / 255])
